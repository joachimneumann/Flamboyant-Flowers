...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    options connectionOptions: UIScene.ConnectionOptions) {
        for userActivityy: NSUserActivity in connectionOptions.userActivities
        where userActivityy.title == "show a flamboyant flower" {
        ...
        guard _ = (scene as? UIWindowScene) else { return }
    }
    ...
    func scene(_ scene: UIScene, continue userActivity: NSUserActivity) {
        if userActivity.activityType == "com.joachimneuman.flamboyantFlowers" {
            startedFromShortCut = true
        }
    }
}
